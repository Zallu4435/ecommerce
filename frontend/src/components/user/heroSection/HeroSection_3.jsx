...
const HeroSection_3 = () => {
  ...
  return (
    <div className="pt-16 bg-gray-50 dark:bg-gray-800 bg-gradient-to-b from-gray-100 to-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:shadow-none">
      <h1 className="mt-8 lg:text-5xl text-2xl md:text-3xl font-medium text-center lg:font-bold lg:mb-7 text-gray-900 dark:text-gray-100">Popular Categories</h1>
        ...
        <Slider {...settings}>
          {slides.map((slide, index) => (
            <div key={index} className="slide flex flex-col items-center mx-2">
              ...
              {/* Text Below Image */}
              <p className="text-center text-sm sm:text-base md:text-lg lg:text-xl font-medium text-gray-900 dark:text-gray-100">{slide.text}</p>
            </div>
          ))}
        </Slider>
      </div>
