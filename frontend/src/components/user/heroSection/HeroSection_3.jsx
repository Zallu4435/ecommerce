...
const HeroSection_3 = () => {
  ...
  if (isLoading) {
    return (
      <div className="pt-16 bg-gray-50 dark:bg-gray-800">
  ...
  if (isError) {
    return (
      <div className="pt-16 bg-gray-50 dark:bg-gray-800">
        ...
        <div className="mx-auto max-w-xl mt-6 px-6 py-6 text-center rounded-xl border border-red-200 bg-red-50 text-red-700 dark:border-red-800 dark:bg-red-900/30 dark:text-red-200">
  ...
  const hasCategories = Array.isArray(popular_categories?.products) && popular_categories.products.length > 0;
  ...
  return (
    <div className="pt-16 bg-gray-50 dark:bg-gray-800 bg-gradient-to-b from-gray-100 to-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:shadow-none">
      ...
      {hasCategories ? (
        ...
        <div className="mx-auto max-w-xl mt-6 px-6 py-6 text-center rounded-xl border border-gray-200 bg-white text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-900/40 dark:text-gray-200">
