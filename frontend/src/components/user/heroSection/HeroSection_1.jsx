...
import { heroImg_1, heroImg_2, heroImg_3 } from "../../../assets/images"; // Make sure you have these images
  ...
  const slides = [
    {
      ...
      description: "You appear ordinary if you dress simply. We are here to help you look extraordinary.",
      buttonText: "Shop Now",
    },
    {
      image: heroImg_2,
