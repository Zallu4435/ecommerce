...
import { useGetComparisonListQuery, useRemoveFromComparisonMutation } from '../../../redux/apiSliceFeatures/ComparisonApiSlice';
...
const Compare = () => {
  ...
  const { data: compareItem = [], isLoading, isError } = useGetComparisonListQuery();
  ...
  const handleRemoveProduct = async (productId) => {
    try {
      ...
      if (response?.data?.comparison) {
        toast.success('Product removed from comparison:', response.data.comparison);
      } else {
