...
import { BarChart, DollarSign, Package, ShoppingCart, TrendingUp, Users, ChevronDown } from 'lucide-react';
import {
...
const AdminSalesManagement = () => {
  ...
  const {
    ...
    : { dateRange }, { refetchOnMountOrArgChange: true });
  const {
    data: salesOverview,
            ...
            {isCustomDateRange && (
              <div className="flex space-x-2">
                <input
                  ...
                  className="border dark:border-gray-300 border-gray-700 rounded-md py-2 px-3 text-gray-200 text-sm dark:text-gray-700 bg-gray-800 dark:bg-white"
                />
                <input
                  type="date"
                  name="end"
                  ...
                  onChange={handleCustomDateChange}
                  className="border dark:border-gray-300 border-gray-700 rounded-md py-2 px-3 text-gray-200 text-sm bg-gray-800 dark:text-gray-700 dark:bg-white"
                />
              </div>
            )}
            <button
